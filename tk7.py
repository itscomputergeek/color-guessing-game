...
def harsita():
    ans=tmsg.askretrycancel("Harshita se dosti kar lo"," Harshita dost nahi banegi")
    if ans:
...
Label(root,text="App kitne pagal ho Harsita ke dost bane k liye ").pack()
myslider= Scale(root,to=100,orient=HORIZONTAL,tickinterval=50)
myslider.pack()

Button(root,text= "Rate" , pady=10,command=harsita).pack()
